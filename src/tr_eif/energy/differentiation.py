"""Coordinate-differentiation policy for TR-EIF energy models."""
...
class CoordinateDifferentiation:
    """Finite-difference policy for fixed-graph energy derivatives."""
    ...
    def inverse_central_span(self) -> float:
        """Return the reciprocal of the central-difference span."""
